...
export const parameterDefinitions = {
  ...
  queenLayingTrendAlpha: {
    label: 'Income Trend Smoothing',
    description: 'EMA smoothing factor for the food-income trend signal (0–1). Higher = reacts faster to recent income changes, noisier.',
    group: 'Queen',
    min: 0.001,
    max: 0.2,
    step: 0.001,
  ...
  queenLayingTrendSensitivity: {
    label: 'Income Trend Sensitivity',
    description: 'How strongly a negative income trend throttles egg laying. Higher = brakes harder on early signs of decline.',
    group: 'Queen',
    min: 0,
    max: 200,
    step: 5,
