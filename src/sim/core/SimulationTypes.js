...
export function sanitizeTickConfig(config = {}) {
  return {
    ...
    queenLayingIncomeBrake: Boolean(config.queenLayingIncomeBrake),
    queenLayingTrendAlpha: clampRangeNumber(config.queenLayingTrendAlpha, 0.01, 0.001, 0.2),
    queenLayingTrendSensitivity: clampFiniteRangeNumber(config.queenLayingTrendSensitivity, 40, 0, 500),
