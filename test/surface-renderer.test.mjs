  ...
  try {
    ...
    const colony = {
      ants: [
        ...
        { id: 'lower-surface-ant', x: 10, y: 6, baseColor: '#444444', carryingType: 'none', hunger: 70, health: 85 },
      ],
      foodStored: 0,
    };
    ...
    assert.ok(unitRects.some((call) => call.x === 10 && call.y === 6), 'surface ants in lower surface rows should still render');
